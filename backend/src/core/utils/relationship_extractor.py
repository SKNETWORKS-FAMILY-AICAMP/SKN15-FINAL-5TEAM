...
- Co-occurrence analysis (60%): Statistical patterns in entity mentions
- Rule-based patterns (20%): Known relationship types (TRAINS_WITH, HAS_AFFINITY, etc.)
- LLM-based extraction (20%): Context-aware relationship identification

Relationship types:
- TRAINS_WITH: Character trains with another character
- HAS_AFFINITY: Character has positive/negative relationship with another
- LOCATED_IN: Entity is in a location
- USES_SKILL: Character uses a skill
- OCCURRED_IN: Event happened in a location
- BELONGS_TO: Item belongs to character
"""
...
class RelationshipExtractor:
    ...
    1. Co-occurrence analysis (60%): Entities appearing together
    2. Rule-based patterns (20%): Keyword-based relationship detection
    3. LLM-based extraction (20%): Complex context understanding
    """
    ...
    def __init__(
        ...
        # Relationship type rules (keyword patterns)
...
"""
    ...
    def _merge_duplicate_relationships(
        ...
        for rel in relationships:
            # Normalize direction (always put lower ID first for consistency)
