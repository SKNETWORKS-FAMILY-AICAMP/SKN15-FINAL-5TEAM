...
from src.core.utils.embedding_matcher import EmbeddingClient, EmbeddingMatcher, get_embedding_client
from ..services.generation.fallback_llm import generate_off_topic_response
from src.core.utils.llm_client import LLMClient, get_llm_client
from src.core.utils.logger import log
from ..services.classification.intent_handler import detect_intent_with_llm
from ..services.classification.intent_detector import detect_intents
from src.core.utils.config_loader import get_config_loader
...
# ============================================================
# 🎯 라우터 에이전트 개요
# - 사용자의 발화가 시나리오와 관련 있는지 판정
# - 1차 임베딩 매칭 → 2차 LLM 판별 흐름
# ============================================================
