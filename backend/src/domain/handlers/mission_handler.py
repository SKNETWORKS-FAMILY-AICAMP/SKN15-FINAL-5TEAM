...
from src.core.utils.llm_client import get_llm_client
from ..services.orchestration.scene_tools import (
    get_i18n_entries,
    get_next_stage_tag,
    get_stage_type,
    get_speaker_pool,
)
from ..services.generation.fallback_tools import trigger_fallback
from src.core.utils.logger import log
from src.core.utils.text_matcher import detect_mission_target
