...
VALUES
    ('MIZUNOTO', '계급 없음(癸)', 'Mizunoto', '癸', 0, 1, 10, '🌱', '귀살대 입문자. 기초 훈련 중인 단계'),
    ('MIZUNOE', '계급 계(癸)', 'Mizunoe', '癸', 100, 11, 20, '🌿', '기초를 다진 초심자'),
    ('KANOTO', '계급 경(庚)', 'Kanoto', '庚', 300, 21, 30, '🪴', '실전 경험을 쌓아가는 단계'),
    ('KANOE', '계급 경(庚)', 'Kanoe', '庚', 600, 31, 40, '🌳', '어느 정도 실력을 인정받은 대원'),
    ('TSUCHINOTO', '계급 무(戊)', 'Tsuchinoto', '戊', 1000, 41, 50, '⚔️', '중견 귀살대원'),
    ('TSUCHINOE', '계급 무(戊)', 'Tsuchinoe', '戊', 1500, 51, 60, '🗡️', '숙련된 전사'),
    ('HINOTO', '계급 병(丙)', 'Hinoto', '丙', 2200, 61, 70, '💫', '뛰어난 실력자'),
    ('HINOE', '계급 병(丙)', 'Hinoe', '丙', 3000, 71, 80, '✨', '주급 후보'),
    ('KINOTO', '계급 갑(甲)', 'Kinoto', '甲', 4000, 81, 90, '⭐', '최상급 대원'),
...
VALUES
    ...
    (
        ...
        'AU 세계관. 귀살대원들이 아이돌 그룹 또는 밴드로 데뷔! 화려한 무대 위에서 펼쳐지는 그들의 이야기',
        '/images/아이돌밴드.png',
        '/images/아이돌밴드.png',
        false,
        '엔터테인먼트 · 음악 · 팬심',
